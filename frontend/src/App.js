        ...
        const off = onEvent((event) => {
            switch (event.kind) {
                ...
                case "log":
                    ...
                    console[event.level === "error" ? "error" : event.level === "warn" ? "warn" : "log"]("[backend]", event.message);
                    break;
            }
        });
        return off;
    }, []);
    return (_jsxs(_Fragment, { children: [_jsx(Visualizer, {}), _jsx(TimelineMidiPlayback, {}), _jsxs("div", { className: "app-root", children: [_jsx(TopBar, {}), _jsxs("main", { className: "app-main", children: [_jsx(Sidebar, {}), _jsxs("div", { className: "main-col", children: [_jsx(TrackList, {}), _jsx(MasterEqPanel, {})] })] })] }), _jsx(EditorHost, {}), _jsx(ModalStackOverlay, {})] }));
}
