 ...
 */
export function DitheredImage({ src, alt, width, height, threshold = 128, className, }) {
    ...
    return (_jsx("canvas", { ref: canvasRef, width: width, height: height, "aria-label": alt, role: "img", className: `${styles.dithered} ${ready ? styles.ready : ""} ${className ?? ""}`, style: { width, height } }));
}
