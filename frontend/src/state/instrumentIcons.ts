...
export const INSTRUMENT_ICON_OPTIONS: InstrumentIconOption[] = [
  ...
  { icon: "ph:music-notes-simple", label: "Drum", tags: ["drum", "kit", "percussion"] },
  ...
  { icon: "ph:guitar", label: "Strings", tags: ["violin", "viola", "cello", "strings"] },
  ...
  { icon: "ph:wind", label: "Horn", tags: ["brass", "trumpet", "horn"] },
