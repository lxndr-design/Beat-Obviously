...
- Aether Synth: `[~]` real but not mature. It has multi-osc wavetable controls, unison, modulation routing, cached wavetable lookup, analyzer/preview surfaces, preset beginnings, and the first durable wavemap metadata/resynthesis foundation. It lacks deep wavemap drawing/import UI, richer modulators, a proper FX rack, and full modulation UX.
