...
- `[~]` Add richer envelopes: Env 1 curve shapes now roundtrip through the patch contract, Solid editor, browser preview, native parser, native render shaping, IPC import, and native persistence; Env 2 modulation semantics and looping envelopes remain.
