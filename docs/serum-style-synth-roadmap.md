...
- `[~]` Add proper voice stealing, mono/legato, glide, pitch bend, mod wheel, velocity, keytracking. Filter keytracking, keytrack modulation source routing, mod wheel routing, runtime pitch bend, linked-note glide timing, and initial velocity modulation now exist across patch/browser/native paths; voice stealing, mono/legato, and deeper expression UX remain.
