...
- `[~]` Add LFO 2+, tempo sync, one-shot mode, smoothing, phase/random controls. LFO 2 now exists as a patch/native/browser modulation source; tempo-sync behavior, one-shot mode, smoothing, and phase/random controls still need completion.
