...
- `[~]` Custom frame editor exists with audio import, normalize, and evolve helpers, but needs deeper drawing controls and clearer visual semantics.
...
- `[~]` Add wavetable import, morphing, drawing, FFT/resynthesis research lane, and frame normalization rules. Audio-file wavemap import, deterministic frame normalization, and seeded non-AI evolution now exist in the Solid oscillator editor; deeper drawing, FFT analysis, and morphing controls remain.
