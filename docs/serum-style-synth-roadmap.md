...
- `[~]` Dynamic modulation routes exist for LFO 1, LFO 2, Env 1, Env 2, velocity, and keytrack sources to oscillator, filter, amp, and unison targets.
...
- `[~]` Add proper voice stealing, mono/legato, glide, pitch bend, mod wheel, velocity, keytracking. Filter keytracking, keytrack modulation source routing, and initial velocity modulation now exist across patch/browser/native paths; voice stealing, mono/legato, glide behavior, pitch bend, mod wheel, and deeper expression UX remain.
