...
- Effects/automation: `64%`
  ...
  - Next steps: bus routing UI, named effect preset library, automation selection browser tests, visible track automation lanes, and unified project/instrument automation UX.
- UI/UX coherence: `54%`
...
- `[~]` Project/segment/note automation are native. Piano-roll note lanes and first Segment Editor Aether segment lanes now have visible editing surfaces; arrangement track lanes and broader project/instrument automation UX remain early.
