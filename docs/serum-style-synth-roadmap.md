...
- `[~]` Add wavetable import, morphing, drawing, FFT/resynthesis research lane, and frame normalization rules. Audio-file wavemap import now exists in the Solid oscillator editor with native IPC/browser decode paths; deeper drawing, FFT analysis, normalization, and morphing controls remain.
