...
- `[~]` Add proper voice stealing, mono/legato, glide, pitch bend, mod wheel, velocity, keytracking. Filter keytracking now exists across patch/browser/native paths; voice stealing, mono/legato, glide behavior, pitch bend, mod wheel, and deeper velocity routing remain.
