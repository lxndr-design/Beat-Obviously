...
- `[~]` Note/segment automation UI.
  ...
  - Remaining: arrangement-view track automation lanes and fuller browser interaction parity coverage for arbitrary multi-point edits.
...
2. Add arrangement-view track automation lanes and fuller browser interaction coverage for arbitrary multi-point automation edits.
