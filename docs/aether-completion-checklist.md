...
- `[~]` Note/segment automation UI.
  ...
  - Proof: editor interaction tests for lane creation/value-edit/drag-value helpers, synth verifier coverage for macro-lane preview output and curve-shaped preview output, plus future browser/editor interaction tests for arbitrary multi-point lane editing.
