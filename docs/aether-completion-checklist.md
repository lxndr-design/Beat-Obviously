...
- `[~]` Note/segment automation UI.
  ...
  - Remaining: arrangement-view track automation lanes, visible note multi-point lane editing UI, and fuller playback/live-export parity coverage.
...
2. Add arrangement-view track automation lanes and visible note multi-point lane editing UI.
