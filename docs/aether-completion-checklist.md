...
- `[~]` Performance/expression UX.
  - Done: filter keytracking, keytrack routing, mod wheel routing, runtime pitch bend, linked-note glide, max voice caps, note stealing, mono voice caps, legato retune, Aether patch/editor glide editing, and an editor-visible expression/performance summary for voices, legato/glide, pitch bend, velocity, keytrack, and mod wheel.
  - Remaining: dedicated editable expression controls and realtime controller feedback while MIDI input/playback is active.
