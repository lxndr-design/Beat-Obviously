...
- `[~]` Browser-level flow coverage for synth editing, wavemap import/draw, macro assignment, and note automation lanes.
  ...
  - Remaining: broader synth editing, drag-based arbitrary multi-point lane editing, deeper pointer-draw wavemap interaction coverage, and full note automation interaction flows.
...
1. Add browser-level flow coverage for broader synth editing, wavemap import/draw, arbitrary multi-point lane editing, and broader note/segment/track automation interactions.
