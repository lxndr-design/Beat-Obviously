...
2. Add arrangement-view track automation point add/remove controls and fuller browser interaction coverage for arbitrary multi-point automation edits.
