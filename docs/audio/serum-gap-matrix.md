...
| Two independent main oscillators | Source/table, tuning, phase/randomization, static unison, level and pan are independent; legacy shared unison migrates compatibly | B1 | Add per-source filter/direct/FX routing and independent unison modulation targets |
