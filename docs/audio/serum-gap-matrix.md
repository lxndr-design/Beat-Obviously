...
| MPE/per-note expression | Independent mod wheel, poly/channel pressure, CC74 timbre, and per-channel RPN 0,0 pitch ranges; fixed channel caches initialize Aether voices deterministically before rendering and survive cross-channel steals correctly | B3/B14/B18/B19 | Add zone/master-channel negotiation, capability exchange, persisted performance mapping, and non-Aether initialization before claiming MPE completeness |
