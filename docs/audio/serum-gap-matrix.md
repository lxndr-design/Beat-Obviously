...
| MPE/per-note expression | Independent mod wheel, poly/channel pressure, CC74 timbre, per-channel RPN 0,0 pitch ranges, and a versioned persisted contiguous master/member zone; fixed channel caches initialize Aether voices deterministically and survive cross-channel steals | B3/B14/B18/B19/B20 | Add MIDI-CI/profile or RPN 6 automatic negotiation, product controls, and non-Aether initialization before claiming MPE completeness |
