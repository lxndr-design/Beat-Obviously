...
| MPE/per-note expression | Independent mod wheel, poly/channel pressure, and CC74 timbre sources plus partial note automation; fixed channel caches now initialize Aether voices deterministically before rendering and survive cross-channel steals correctly | B3/B14/B18 | Add zone/master-channel and RPN pitch-range negotiation, capability exchange, persisted performance mapping, and non-Aether initialization before claiming MPE completeness |
