...
| Phase memory/randomization | Independent A/B retrigger and memory modes implemented with product controls; retrigger retains deterministic random-depth behavior | B4/B24 | Add audible regression fixtures across voice stealing/legato combinations |
