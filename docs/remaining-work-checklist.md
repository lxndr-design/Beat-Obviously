...
2. `[~]` Automation editing completion.
   ...
   - Done: Segment Editor Aether automation value handles are covered in a true browser fixture for start/mid/end drag edits.
   - Done: Track Details Aether automation value handles are covered in a true browser fixture for start/mid/end drag edits.
...
- `[~]` Heavier nonlinear warp experiments.
  - Done: bounded table-generation `mirror` warp mode across editor/browser/native/persistence/test surfaces.
  - Remaining: runtime nonlinear warp experiments after runtime warp oversampling strategy exists.
