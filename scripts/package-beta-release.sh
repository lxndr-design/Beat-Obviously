...
APP_PATH="${BEAT_APP_OUTPUT_PATH:-${HOME}/Applications/Beat.app}"
RELEASE_DIR="${BEAT_RELEASE_DIR:-${HOME}/Downloads/Beat Public Release}"
ARCHIVE_PATH="${RELEASE_DIR}/Beat-${VERSION}-macOS-arm64.zip"
CHECKSUM_PATH="${ARCHIVE_PATH}.sha256"

BEAT_APP_OUTPUT_PATH="${APP_PATH}" "${ROOT_DIR}/scripts/package-macos.sh"
